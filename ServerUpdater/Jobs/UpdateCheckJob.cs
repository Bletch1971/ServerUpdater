        ...
        private bool CheckForUpdates()
        {
            try
            {
                ...
                using (Process process = new Process())
                {
                    ...
                    process.StartInfo.Arguments = $"+login anonymous +app_info_update 1 +app_info_print {Settings.Instance.ServerAppId} +app_info_print {Settings.Instance.ServerAppId} +quit";
